...
```
sudo apt-get install qtbase5-dev libqt5serialport5-dev libqt5sql5-sqlite libqt5svg5-dev libusb-1.0-0-dev python3-dev libcec-dev libxcb-util0-dev libxcb-randr0-dev libxrandr-dev libxrender-dev libavahi-core-dev libavahi-compat-libdnssd-dev libjpeg-dev libturbojpeg0-dev aptitude qt5-default rsync libssl-dev zlib1g-dev
```
