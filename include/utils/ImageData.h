...
public:
	...
	{
		memcpy(_pixels, other._pixels, static_cast<long>(other._width * other._height * sizeof(Pixel_T)));
	}
	...
	void clear()
	{
		...
		memset(_pixels, 0, static_cast<unsigned long>(_width * _height * sizeof(Pixel_T)));
	}
