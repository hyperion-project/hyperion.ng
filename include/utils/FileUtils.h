...
namespace FileUtils {
	...
	///
	bool fileExists(const QString& path, QSharedPointer<Logger> log, bool ignError=false);
	...
	/// @return               true on success else false
	///
	bool readFile(const QString& path, QString& data, QSharedPointer<Logger> log, bool ignError=false);
	...
	/// @return               true on success else false
	///
	bool removeFile(const QString& path, QSharedPointer<Logger> log, bool ignError=false);
