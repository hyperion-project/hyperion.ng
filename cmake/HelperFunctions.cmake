...
function(get_build_interface_include_directory)
	...
	set(_output "")
	get_target_property(_target_includes ${arg_TARGET} INTERFACE_INCLUDE_DIRECTORIES)
	foreach(include ${_target_includes})
		if(include MATCHES "\\$<BUILD_INTERFACE:([^,>]+)>")
			list(APPEND _output "${CMAKE_MATCH_1}")
		else()
			list(APPEND _output "${include}")
		endif()
	endforeach()
