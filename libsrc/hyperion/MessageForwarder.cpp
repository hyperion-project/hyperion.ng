	...
	, _priority(140)
{
	...
	// component changes
	connect(_hyperion, &Hyperion::compStateChangeRequest, this, &MessageForwarder::compStateChangeRequest);
...
void MessageForwarder::compStateChangeRequest(const hyperion::Components component, bool enable)
{
