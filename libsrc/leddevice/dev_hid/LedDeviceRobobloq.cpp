...
namespace
{
	...
	constexpr int PROTOCOL_INTERFACE_NUMBER = 0;
...
int LedDeviceRobobloq::open()
{
	...
	// Unlike enumeration, the Linux libusb backend can resolve the usage pair
	// after the interface has been opened and claimed.
