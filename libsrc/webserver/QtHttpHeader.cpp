...
const QByteArray & QtHttpHeader::ContentSecurityPol   = QByteArrayLiteral ("Content-Security-Policy");
const QByteArray & QtHttpHeader::XFrameOptions        = QByteArrayLiteral ("X-Frame-Options");
